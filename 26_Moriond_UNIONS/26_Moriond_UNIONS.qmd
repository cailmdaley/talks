...
::: {style="margin-top:80px;line-height:2.0em"}
...
::: {style="line-height:2.2em;margin-top:30px"}
...
- **Covariance** — analytical (CosmoCov, iNKA);<br>validated with jackknife and 350 GLASS mocks
...
- **Intrinsic alignments** — NLA model; $A_\mathrm{IA}$ degenerate with $S_8$ in one bin; Gaussian prior from red/blue split ($0.83 \pm 0.7$)
