...
<div class="eqs"></div>
<svg class="pP" data-h="110" data-foot-at="1" viewBox="0 0 1730 300" width="1730" height="300"></svg>
<div class="two lower">
  <div class="toycol">
    <svg class="pMps" data-h="234" data-foot-at="1" data-x0="92" data-w="392"
         viewBox="0 0 520 326" width="520" height="326"></svg>
    <div class="toyfoot"></div>
  </div>
  <div class="figblock">
    ...
    <div class="figside">
      ...
      <div class="figtitle">the same shape, in Quaia</div>
...
drew. It is flat. At every k the phases of a hundred and sixty deltas point in random
directions, so they add *incoherently* — the sum is a random walk, and its square is the number
of sources. That is the shot-noise floor, sigma w-i squared, and it is reached almost
immediately, an order of magnitude in k below pi over theta-c.

Now drop a real footprint on it — edges, and a few holes. Sources inside the gaps simply do not
...
footprint, so the spectrum lifts off the floor — and by k of about ten it has fallen back onto the floor
again, ten times below pi over theta-c. Red rise, white floor. That is the shape on the right,
in Quaia, from the paper. Ours is a decade; theirs is six, and the only difference is the number
of sources — the rise is capped at N times the coverage, and Quaia has millions.
