...
<svg class="pP" data-h="190" viewBox="0 0 1730 360" width="1730" height="360"></svg>
<div class="two">
  <div><svg class="pKC" data-h="172" data-x0="90" data-w="700"
       data-foot="the toy: the kernel rattles around the floor and never narrows"
       viewBox="0 0 850 272" width="850" height="272"></svg></div>
  <div class="paperfig inset">
    <img src="images/wolz_Nw_quaia.png" alt="Quaia catalogue mask pseudo-spectrum">
    <div class="mlab"><b>the real sky</b>the catalogue mask falls onto its white floor; a pixelated mask keeps falling — pixels are an implicit band-limit</div>
  </div>
</div>
</div>
```
