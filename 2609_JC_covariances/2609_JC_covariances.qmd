...
Now do that for every pair in bin i against every pair in bin j — a few hundred times a few
hundred here, and that is one cell of the matrix. Fill in every cell and you have the whole
covariance.
