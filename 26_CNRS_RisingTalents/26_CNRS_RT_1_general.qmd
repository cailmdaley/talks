...
::: {style="margin-top:0.3em"}
My doctoral work measured **CMB lensing** with **SPT-3G**: the microwave background is bent by the
matter it crosses, so reconstructing that bending maps it across most of cosmic history.
:::

::: {style="margin-top:0.55em;font-size:0.9em"}
- Led **one of three independent lensing pipelines**, with **bias-hardening against galaxy and
  dust contamination — a first for this class of SPT analysis**
