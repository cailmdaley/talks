...
- Mitigated through sample selection and scale cuts
...
![](images/contour_survey_comparison.png){width=100% fig-align="right"}
:::
::: {.fragment fragment-index=0}
![](images/s8_convergence_with_unions.png){width=100% fig-align="right"}
:::
::::
