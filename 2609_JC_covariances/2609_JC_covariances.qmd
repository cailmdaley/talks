...
<div class="eqs"></div>
<svg class="pP" data-h="80" data-foot-at="1" viewBox="0 0 1730 252" width="1730" height="252"></svg>
<div class="two lower">
  <div class="toycol">
    <svg class="pMps" data-h="300" data-foot-at="1" data-x0="132" data-w="352"
         viewBox="0 0 520 392" width="520" height="392"></svg>
  </div>
  <div class="figblock">
...
drew. It is flat. At every k the phases of three hundred deltas point in random
...
is reached almost immediately, an order of magnitude in k below pi over theta-c.
...
in Quaia, from the paper. Ours is a decade and a half; theirs is six, and the only difference is
the number of sources — the rise cannot exceed N, and Quaia has millions.
...
## Band-limit the mask {.nka-slide}

```{=html}
<div class="nka" data-step="7" data-ledger-from="6">
<div class="eqs"></div>
<div class="ctl-slider cloud">
...
<svg class="pP" data-h="80" data-foot-at="0" data-cloud="1"
     viewBox="0 0 1730 252" width="1730" height="252"></svg>
<svg class="pMps" data-h="316" data-foot-at="0" data-cloud="1" data-x0="132" data-w="1560"
     viewBox="0 0 1730 404" width="1730" height="404"></svg>
</div>
```
...
white floor above pi over theta-c is cut off. The thing you wanted gone is gone and the thing
you wanted kept is kept.
...
<div class="corr">
  <div class="fragment">
    <span class="nm">take the self-pairs back out</span>
  ...
  <div class="fragment">
    <span class="nm">and back in, exactly</span>
