...
A footnote I will not put on the slide. Strictly that map wants the expectation of a-i squared,
and what you have is one realisation, so the paper substitutes a-i squared itself. That is
unbiased in the mean but its pseudo-spectrum then involves fourth moments, and because the
expectation of a product is not the product of expectations it overestimates the variance map's
power at high ell. They correct it analytically by Wick — a self-pair correction to a self-pair
term. Ask me if you want the details.
...
<div class="r-stack figswap">
  <div class="figone fragment fade-out" data-fragment-index="0">
    ...
    <div class="papercap"><span class="src">Nagura et al., arXiv:2605.16186 &mdash; Fig. 4</span>Correlation matrices of \(\mathrm{Cov}(\tilde C_\ell,\tilde C_{\ell'})\) computed using the iNKA (left) and measured from Gaussian simulations (center). The right plot shows the fractional difference \(\mathrm{Cov}^{\rm iNKA}/\mathrm{Cov}^{\rm sim}-1\).</div>
  </div>
  <div class="figone withbox fragment fade-in" data-fragment-index="0">
    ...
    <div class="punchbox">
      ...
      <span class="pv">within 10% &nbsp;<i class="pvs">Fig. 2</i></span>
      <span class="par">&darr;</span>
      <span class="pq">on \( {\rm diag}\,{\rm Cov}(\xi,\xi) \), \( \theta\approx6' \)</span>
      <span class="pv hot">&minus;25 to &minus;30% &nbsp;<i class="pvs">Fig. 3</i></span>
    </div>
    </div>
    <img src="images/nagura_cov_xi.png" alt="Cov(xi,xi) diagonal: sims, projected sim harmonic covariance, projected iNKA">
    <div class="papercap"><span class="src">Nagura et al., arXiv:2605.16186 &mdash; Fig. 3</span>Diagonal components of \(\mathrm{Cov}(\xi[\theta_-,\theta_+],\xi[\theta'_-,\theta'_+])\), measured from Gaussian realizations (dashed line) and calculated using Eq. 12 (solid lines).</div>
  </div>
</div>
</div>
```
