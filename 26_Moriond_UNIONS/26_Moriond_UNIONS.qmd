...
- **(i)** Three blinds and both pipelines — blind A is the physical $n(z)$; configuration and harmonic space agree within ${\lesssim}0.6\sigma$
- **(ii)** Broadly consistent with *Planck* and other Stage-III shear surveys
- **(iii–v)** Robustness tests: scale cuts, non-linear model, covariance — all shifts $< 0.7\sigma$
:::

::: notes
This is the summary figure. At the top: our three blinds, showing that the unblinding procedure is clean. Below: UNIONS compared to Planck, DES, KiDS, and HSC. We're consistent with all of them — the error bars are large, but the consistency across pipelines and across surveys is the message.
The bottom section shows robustness: changing the scale cuts, switching from HMCode to Halofit, using a different covariance — none of these shifts the answer by more than 0.7 sigma.
:::
...
![](images_local/contours_survey_comparison.png){width=55% fig-align="center"}

::: {style="font-size:0.8em;text-align:center"}
$\Omega_m$–$S_8$ contours: UNIONS (harmonic + config-space) compared to DES Y3, KiDS-1000, HSC Y3, and *Planck* 2018.
:::
