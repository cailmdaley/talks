...
::: {style="margin-top:0.5em;text-align:center;font-size:0.75em"}
<!-- TODO: insert METR capability trajectory figure here -->
<!-- placeholder: the METR 2026 task-horizon graph -->
*[METR capability trajectory — insert figure]*
:::
...
::: {style="margin-top:1em;font-style:italic"}
Running through both: **agentic methods make the breadth tractable** — more systematic exploration, more validation checks, complete decision records.
:::
...
::: {style="margin-top:0.5em"}
The risk that must be named: **AI systems hallucinate.** They optimize for plausibility over correctness.
:::
...
::: {style="margin-top:1.5em;font-style:italic;text-align:center"}
Thank you.
:::

::: notes
Short, punchy close. Three lines, same order as the talk. Don't add new information here.
:::
