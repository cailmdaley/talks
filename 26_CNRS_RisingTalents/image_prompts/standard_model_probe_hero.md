...
- Prefer a mostly graphite/gray Gaussian random field through the upper and middle matter
  region. Avoid an overall orange web; warm color should appear only as subtle late-time specks
  at cluster nodes.
...
- Supernovae should be about three simple blue glows embedded at random positions in the
  lower nonlinear cosmic web, not connected by a ladder line. Nearby/lower-time supernovae
