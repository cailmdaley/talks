...
::: {style="font-size:0.88em;line-height:1.5em;margin-top:16px;margin-bottom:10px"}
...
::: {.pte-table-container}
![](images_local/pte_table_appendix_paper3.png){width=80% fig-align="center"}
:::
...
::: notes
Here are the unblinded UNIONS contours — configuration space in orange, harmonic space in blue, and Planck in pink. Blind B turned out to be the physical n(z).
Both UNIONS analyses are consistent with each other and with Planck — about 1 sigma. The contours are wide because we're fitting a single source redshift bin — tomography will tighten these substantially.
...
- **(i)** Three blinds and both pipelines — blind B is the physical $n(z)$; configuration and harmonic space agree within ${\sim}0.5\sigma$
- **(ii)** Broadly consistent with *Planck* (${\sim}1\sigma$) and other Stage-III shear surveys
