...
def generate_index_html():
            ...
            for dir_name in dirs:
                if dir_name not in exclude_dirs:
                    ...
                    if os.path.exists(index_html_path):
                        ...
                        last_modified_date = datetime.fromtimestamp(last_modified_time).strftime('%B %d, %Y')
    ...
    with open(index_file_path, 'w') as index_file:
        ...
        index_file.write('a { text-decoration: none; color: #1a73e8; font-size: 18px; }\n')
        ...
        for dir_name, last_modified_date, _ in talks:
            index_file.write(f'<li><a href="{dir_name}/index.html">{dir_name}</a> ({last_modified_date})</li>\n')
